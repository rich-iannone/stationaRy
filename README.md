...
``` r
lga_met_data
#> # A tibble: 28,262 x 10
#>    id    time                 temp    wd    ws atmos_pres dew_point    rh
#>    <chr> <dttm>              <dbl> <int> <dbl>      <dbl>     <dbl> <dbl>
#>  1 7250… 2017-01-01 00:51:00   7.8   230   4.6      1012.      -3.9  43.4
#>  2 7250… 2017-01-01 01:00:00   7.8   230   4.6      1012.      -3.9  43.4
#>  3 7250… 2017-01-01 01:51:00   7.2   230   3.6      1012.      -2.2  51.3
#>  4 7250… 2017-01-01 02:51:00   7.8   240   5.7      1013.      -3.3  45.4
#>  5 7250… 2017-01-01 03:51:00   7.8   240   4.6      1013.      -3.9  43.4
#>  6 7250… 2017-01-01 04:00:00   7.8   240   4.6      1013.      -3.9  43.4
#>  7 7250… 2017-01-01 04:51:00   8.3   240   4.6      1014.      -4.4  40.4
#>  8 7250… 2017-01-01 05:51:00   8.3   250   5.1      1015.      -3.9  41.9
#>  9 7250… 2017-01-01 06:51:00   8.3   260   5.7      1016.      -3.3  43.8
#> 10 7250… 2017-01-01 07:00:00   8.3   260   5.7      1016.      -3.3  43.8
#> # … with 28,252 more rows, and 2 more variables: ceil_hgt <int>,
#> #   visibility <int>
```
